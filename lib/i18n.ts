...
export const dictionary = {
  ...
  en: {
    brand: "Yunjia Packaging",
    company: "Shenzhen Yunjia Packaging Products Co., Ltd.",
    tagline: "Reliable packaging for brands built to travel",
    ...
    seoDescription: "Yunjia Packaging supplies custom boxes, gift boxes, paper bags, blister trays, labels, sampling, mass production, export support, and online inquiries."
  }
